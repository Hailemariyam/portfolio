...
import { v4 as uuidv4 } from 'uuid'; // Importing uuid for generating unique keys
    ...
    <section className="testimonial--section" id="testimonial">
      ...
      <div className="portfolio--section--container">
        {data?.testimonial?.map((item) => (
          <div key={uuidv4()} className="testimonial--section--card"> {/* Using uuidv4 for generating unique key */}
            <div className="testimonial--section--card--review">
              {Array.from({ length: 5 }, () => (
                <svg
                  key={uuidv4()} // Each SVG element should also have a unique key
